...
return array(
    ...
    "copyright"         => "&copy; author, <http://www.webdesigncreators.com>",
    "name"              => "WDC_003_multi",
    "description"       => "XOOPS 2.3.x, 3 columns",
    "version"           => "2.1",
    "format"            => "Standard / Morpho / Full div",
    "author"            => "WebdesignCreators",
    "demo"              => "",
    "url"               => "",
    "download"          => "",
    "W3C"               => "Xhtml 1.0 Transitional - Css 2",
    "licence"           => "GPL",
    "thumbnail"         => "themedirname.gif",
    "screenshot"        => "themedirname.jpg",
);
?>